    ...
    <section id="contacto" className="py-24 bg-[#111111]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  href: "https://maps.google.com/?q=Fusagasugá+Cundinamarca",
                },
              ].map((item) => (
                <a
                  key={item.label}
          ...
          {/* Right: form */}
          <div className="bg-[#1A1A1A] border border-[#C9A84C]/20 rounded-lg p-8">
            {enviado ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0A0A0A] border border-[#C9A84C]/20 rounded px-4 py-2.5 text-sm text-[#F5F0E8] placeholder-[#EDE5D4]/20 focus:outline-none focus:border-[#C9A84C]/60 transition-colors font-[family-name:var(--font-inter)]"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0A0A0A] border border-[#C9A84C]/20 rounded px-4 py-2.5 text-sm text-[#F5F0E8] focus:outline-none focus:border-[#C9A84C]/60 transition-colors font-[family-name:var(--font-inter)]"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#0A0A0A] border border-[#C9A84C]/20 rounded px-4 py-2.5 text-sm text-[#F5F0E8] placeholder-[#EDE5D4]/20 focus:outline-none focus:border-[#C9A84C]/60 transition-colors font-[family-name:var(--font-inter)] resize-none"
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-[#C9A84C] text-[#0A0A0A] font-semibold rounded hover:bg-[#E2C97E] transition-colors text-sm font-[family-name:var(--font-inter)] tracking-wider flex items-center justify-center gap-2"
                >
