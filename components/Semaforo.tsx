...
function getSemaforo(dias: number) {
  ...
  return { color: "border-[#C9A84C]/20 bg-[#1A1A1A]", dot: "bg-emerald-500" };
}
...
export default function Semaforo() {
  ...
  return (
    <section id="vencimientos" className="py-24 bg-[#111111]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-10 text-center">
          ...
          <a
            href="https://wa.me/573000000000?text=Hola%20Daniela,%20necesito%20ayuda%20con%20un%20vencimiento"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 border border-[#C9A84C]/40 text-[#C9A84C] hover:bg-[#C9A84C] hover:text-[#0A0A0A] transition-all rounded text-sm font-[family-name:var(--font-inter)] font-semibold tracking-wider"
          >
