        ...
        <div className="relative rounded-2xl border border-[#C9A84C]/30 bg-[#F5F0E8] p-10 md:p-16 overflow-hidden">
          ...
          <blockquote className="relative">
            ...
            <footer className="flex items-center gap-4">
              ...
              <span className="flex-1 h-px bg-[#162B1E]/15" />
              <a
                href={`https://wa.me/${WA}?text=${encodeURIComponent("Hola Daniela, quiero trabajar con usted.")}`}
                target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 px-6 py-3 bg-[#162B1E] text-[#F5F0E8] font-semibold rounded-lg hover:bg-[#0F2016] transition-colors text-sm font-[family-name:var(--font-inter)] tracking-wider whitespace-nowrap"
              >
